...
class Vec3 {
    ...
    // private inline function set_x(v:Float):Float return x = v;
    ...
    public inline function subtract(v:Vec3): Vec3 {
        return subtractVec(this, v, new Vec3()) ;
    }
     ...
     */
    public inline static function angleBetween(a:Vec3, b:Vec3): Float {
        // From OgreVector3.cpp:
        //float Vect3::angleBetween(const Vect3& v) const {
