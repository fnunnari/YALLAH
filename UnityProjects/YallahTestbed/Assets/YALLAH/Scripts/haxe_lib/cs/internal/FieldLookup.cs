		protected static string[] fields = new string[]{"a", "b", "g", "i", "j", "m", "r", "w", "x", "y", "z", "_00", "_01", "_02", "_03", "_10", "_11", "_12", "_13", "_20", "_21", "_22", "_23", "_30", "_31", "_32", "_33", "__a", "arr", "get", "len", "map", "pop", "set", "firstIterTime", "multiplied", "flush", "readAll", "getEnumConstructs", "iterStart", "remove", "filter", "update", "aPoseRightEyeRotation", "UpdateEyesRotation", "neckYaw", "resize", "neckRotMaxSpeed", "meanAccu", "writeToFile", "readBytes", "stream", "ready_to_speak", "get_a", "get_b", "get_g", "get_i", "get_j", "get_r", "methodName", "ramp_up_speed", "iterator", "lastIndexOf", "hasNext", "reverse", "aPoseLeftEyeRotation", "_accumulate", "nOccupied", "getBytes", "insert", "length", "writeFullBytes", "writeString", "fromQuat", "realized_visemes", "prefix", "current_weight", "reset_timers", "stop_sequencer", "lengthSquared", "cachedIndex", "toString", "aPoseNeckRotation", "last_time", "iterTimeStart", "varianceAccu", "hashes", "eyeGazeTargetPoint", "speak_start_time", "eyesYaw", "parse_realized_durations", "realized_times", "_eof", "splice", "exists", "equals", "copy", "join", "concat", "close", "active_viseme", "next", "enumConstructor", "eyesRotSpeed", "writeByte", "iterCount", "push", "arrayWrite", "rotate", "LookAtPoint", "get_r0c0", "get_r0c1", "get_r0c2", "get_r0c3", "get_r1c0", "get_r1c1", "get_r1c2", "get_r1c3", "get_r2c0", "get_r2c1", "get_r2c2", "get_r2c3", "get_r3c0", "get_r3c1", "get_r3c2", "get_r3c3", "r0c0", "r0c1", "r0c2", "r0c3", "r1c0", "r1c1", "r1c2", "r1c3", "r2c0", "r2c1", "r2c2", "r2c3", "r3c0", "r3c1", "r3c2", "r3c3", "size", "sort", "quicksort", "vals", "spliceVoid", "writeBytes", "cachedKey", "getEnumName", "createEnumIndex", "createEnum", "next_blink_time", "concatNative", "nBuckets", "className", "updateInterval", "__unsafe_get", "__unsafe_set", "indexOf", "timeAccu", "lookup", "fileName", "iterEnd", "toDynamic", "toFloatArray", "neckPitch", "blink_status", "readByte", "allEnums", "is_speaking", "ramp_down_speed", "customParams", "neckRotTime", "__get", "__set", "inverted", "lineNumber", "enableNeckRotation", "subtract", "upperBound", "unshift", "neckRestTendencyStrenght", "set_r0c0", "set_r0c1", "set_r0c2", "set_r0c3", "set_r1c0", "set_r1c1", "set_r1c2", "set_r1c3", "set_r2c0", "set_r2c1", "set_r2c2", "set_r2c3", "set_r3c0", "set_r3c1", "set_r3c2", "set_r3c3", "_keys", "set_a", "set_b", "set_g", "set_i", "set_j", "set_r", "enumParameters", "position_tts", "eyesPitch", "shift", "reason", "slice"};
